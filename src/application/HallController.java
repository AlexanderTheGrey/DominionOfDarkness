...
public class HallController implements Initializable {
	...
	@FXML private Button hallNexusButton;

	@FXML private Button hallExitButton;
	...
	@FXML private ImageView hallBackground;
	...
	@FXML void goNorth(ActionEvent event) {
		...
		Model.goNorth(hallBackground, hallNexusButton);
	}
	...
	@FXML void goSouth(ActionEvent event) {
		...
		Model.goSouth(hallBackground, hallNexusButton);
	}
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		String path = Main.class.getResource("/application/resources/in_game/ambient_music/Hall Ambience.m4a").toString();
