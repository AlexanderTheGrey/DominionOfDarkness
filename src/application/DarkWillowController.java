...
public class DarkWillowController implements Initializable {
	
	@FXML AnchorPane root;
	
	@FXML private Button darkWillowNexusButton;

	@FXML private Button darkWillowExitButton;
	...
	@FXML private ImageView darkWillowBackground;
	...
	@FXML void goNorth(ActionEvent event) {
		...
		Model.goNorth(darkWillowBackground, darkWillowNexusButton);
	}
	...
	@FXML void goSouth(ActionEvent event) {
		...
		Model.goSouth(darkWillowBackground, darkWillowNexusButton);
	}
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		String path = Main.class.getResource("/application/resources/in_game/ambient_music/Dark Willow Ambience.m4a").toString();
