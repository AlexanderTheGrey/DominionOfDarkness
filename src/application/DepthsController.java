...
public class DepthsController implements Initializable {
	
	@FXML AnchorPane root;
	
	@FXML private Button depthsNexusButton;

	@FXML private Button depthsExitButton;
	...
	@FXML private ImageView depthsBackground;
	...
	@FXML void goNorth(ActionEvent event) {
		...
		Model.goNorth(depthsBackground, depthsNexusButton);
	}
	...
	@FXML void goSouth(ActionEvent event) {
		...
		Model.goSouth(depthsBackground, depthsNexusButton);
	}
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		String path = Main.class.getResource("/application/resources/in_game/ambient_music/Depths Ambience.m4a").toString();
