...
public class WoodsController implements Initializable {
	
	@FXML AnchorPane root;
	
	@FXML private Button woodsNexusButton;

	@FXML private Button woodsExitButton;
	...
	@FXML private ImageView woodsBackground;
	...
	@FXML void goNorth(ActionEvent event) {
		...
		Model.goNorth(woodsBackground, woodsNexusButton);
	}
	...
	@FXML void goSouth(ActionEvent event) {
		...
		Model.goSouth(woodsBackground, woodsNexusButton);
	}
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		String path = Main.class.getResource("/application/resources/in_game/ambient_music/Woods Ambience.m4a").toString();
