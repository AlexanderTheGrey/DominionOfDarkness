...
public class ShipController implements Initializable {
	...
	@FXML private Button shipNexusButton;

	@FXML private Button shipExitButton;
	...
	@FXML private ImageView shipBackground;
	...
	@FXML void goNorth(ActionEvent event) {
		...
		Model.goNorth(shipBackground, shipNexusButton);
	}
	...
	@FXML void goSouth(ActionEvent event) {
		...
		Model.goSouth(shipBackground, shipNexusButton);
	}
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		String path = Main.class.getResource("/application/resources/in_game/ambient_music/Ship Ambience.m4a").toString();
